...
/*
    ...
    List<Field>의 변수를 사용하는 것보다 의도가 담긴 클래스 naming을 사용한다면 목적을 쉽게 파악 할 수 있다.
    List<Field>의 변수 하나만 사용한다면 장점을 크게 못느끼겠지만 다른 DTO 유효성에 대한 에러를 처리하기 위해 변수가 생겨난다면 그때서야 장점을
    느낄 것이다.
